...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // FIXED: Use Bootstrap's built-in tab functionality
  ...
  // Custom tab implementation as fallback
  ...
  // FIXED: Refresh charts in a specific container when it becomes visible
  ...
  // FIXED: Load all data and initialize the dashboard with better error handling
